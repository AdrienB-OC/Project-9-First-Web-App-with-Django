    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('description', models.TextField(blank=True, max_length=2048, verbose_name='Votre demande')),
                ('image', models.ImageField(blank=True, null=True, upload_to='', verbose_name='Image de couverture')),
